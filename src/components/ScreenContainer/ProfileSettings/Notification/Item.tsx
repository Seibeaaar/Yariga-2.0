...
const NotificationItem: FC<NotificationProps> = ({ notification }) => {
  ...
  return (
    <div className="flex gap-[10px] pt-[20px] cursor-pointer py-[10px] border-b pb-[20px] border-border-light dark:border-border-dark transition-all hover:bg-border-light dark:hover:bg-border-dark">
      <div
      ...
      <div>
        ...
        <p className="text-sm text-primary-light dark:text-primary-dark mt-[8px]">
