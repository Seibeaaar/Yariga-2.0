...
const ProfilePictureScreen = () => {
  ...
  const { profilePicturePending } = useSelector(
          ...
          {uploadedImage && showTooltip ? (
            <>
              ...
              <div
                ...
                className="absolute z-[12] top-[100px] right-[50px] flex w-[48px] h-[48px] hover:bg-primary items-center justify-center rounded bg-primary-light opacity-1"
              >
                <FileDownloadIcon />
              </div>
              <div
                onClick={deleteUploadedImage}
                className="absolute z-[12] top-[100px] left-[50px] flex w-[48px] h-[48px] hover:bg-primary items-center justify-center rounded bg-primary-light"
              >
                <CloseIcon />
              </div>
            </>
